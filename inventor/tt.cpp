...
TTPlotWindow::TTPlotWindow(Curve<Vector3>* c, QWidget *parent, const char *name, Qt::WindowFlags wFlags)
    : QWidget( parent, wFlags )
{
  ...
  // Make pp plot
	...
	computeTT(500,500,pt_i,tg_i,pt_j,tg_j,c2.thickness_fast(),table,&min,&max);
...
void TTPlotWindow::paintEvent( QPaintEvent *e) {
...
make it fixed size
*/
void TTPlotWindow::resizeEvent( QResizeEvent * ) {
	/*
...
void TTPlotWindow::mousePressEvent( QMouseEvent *e) {
...
void TTPlotWindow::mouseReleaseEvent( QMouseEvent *e) {
...
void TTPlotWindow::mouseMoveEvent( QMouseEvent *e) {
...
bool TTPlotWindow::convertEvent(QMouseEvent* e, int& x, int& y) {
...
bool TTPlotWindow::reconvertImage() {
  bool success = FALSE;
