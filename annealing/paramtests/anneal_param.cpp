...
// #define LOG_BEST  // ifndef then it logs the dEnergy only
// #define VERBOSE
...
#ifndef LOG_BEST
//    cout << info.m_fTemperature << " " << info.m_fCooling << endl << flush;
//    log << info.m_fTemperature << "\n" << info.m_fCooling << endl << flush;
#else
    WriteBest(rKnot);
#endif
